                ...
                <div className="relative w-full max-w-3xl">
                    ...
                    <div ref={starterMenteeRef} className="relative mb-64 flex flex-col items-start pl-4 md:pl-10">
                        <div 
                            ...
                            className="relative z-40 w-64 h-96 md:w-80 md:h-[28rem] overflow-hidden group border-2 border-black/50 rounded-lg shadow-2xl cursor-pointer"
                        >
                    ...
                    <div className="relative mb-20 flex flex-col items-center justify-center px-4">
                        <div 
                            ...
                            className="relative z-40 w-full max-w-2xl h-[32rem] overflow-hidden group border-2 border-black/50 rounded-lg shadow-2xl cursor-pointer"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 px-4 h-auto shadow-[0_15px_30px_-10px_rgba(0,0,0,0.4)]">
                        ...
                        <div className="flex flex-col">
                            <div 
                                ...
                                className="relative z-40 h-64 md:h-80 overflow-hidden group border-2 border-black/50 rounded-lg cursor-pointer"
                            >
