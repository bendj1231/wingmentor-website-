...
const AppContent: React.FC = () => {
  ...
  // Prevent browser scroll restoration to ensure app starts at top
  useLayoutEffect(() => {
  ...
  // Reset scroll to top on every page transition using useLayoutEffect to prevent visible scrolling
  useLayoutEffect(() => {
    // Reset window scroll
    window.scrollTo(0, 0);
    ...
    // Reset root element scroll (main scroll container in index.html)
